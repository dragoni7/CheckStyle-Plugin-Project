...
public class HalsteadEffortCheckTests {

	@Test
	public void finishTreeTest() {
		DetailAST mockAST = mock(DetailAST.class);
		doReturn(1).when(mockAST).getLineNo();
		HalsteadEffortCheck check1 = spy(new HalsteadEffortCheck());
		...
		HalsteadEffortCheck check2 = spy(new HalsteadEffortCheck());
		...
		verify(check2, times(1)).log(anyInt(), anyString()); // Should log the effort
