...
public class HalsteadLengthCheckTests {
	@Test
	public void finishTreeTest() {
		DetailAST mockAST = mock(DetailAST.class);
		doReturn(1).when(mockAST).getLineNo();
		HalsteadLengthCheck check1 = spy(new HalsteadLengthCheck());
		...
		HalsteadLengthCheck check2 = spy(new HalsteadLengthCheck());
		...
		verify(check2, times(1)).log(anyInt(), anyString()); // Should log the length
