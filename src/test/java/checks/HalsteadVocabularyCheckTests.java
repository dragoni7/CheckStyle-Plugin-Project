...
public class HalsteadVocabularyCheckTests {
	@Test
	public void finishTreeTest() {
		DetailAST mockAST = mock(DetailAST.class);
		doReturn(1).when(mockAST).getLineNo();
		HalsteadVocabularyCheck check1 = spy(new HalsteadVocabularyCheck());
		...
		HalsteadVocabularyCheck check2 = spy(new HalsteadVocabularyCheck());
		...
		verify(check2, times(1)).log(anyInt(), anyString()); // Should log the vocabulary
